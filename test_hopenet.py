...
def parse_args():
    ...
    parser.add_argument('--flip', dest='flip', type=bool, default=False, help='flip input images or not. ')
    ...
    for i, (images, labels, cont_labels, name) in enumerate(test_loader):
        ...
        if args.save_viz:
            ...
            if args.dataset == 'BIWI':
                ...
                # cv2_img = images
                # cv2_img = cv2.imread(os.path.join(args.data_dir, 'IBUG', name + '.jpg'))
            ...
            # cv2.waitKey(0)
            final_name = os.path.join('output/images', os.path.basename(name))
